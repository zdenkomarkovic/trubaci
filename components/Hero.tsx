...
const Hero = () => {
  return (
    <div className="relative flex min-h-[100dvh]">
      ...
      <Image
        src="/hero.jpg"
        alt="Trubači Velika Plana - profesionalni nastup"
        width={1920}
        height={1080}
      ...
      <div className="mt-32 relative flex flex-col gap-5 w-full items-center justify-center text-white z-[1] text-center px-4">
        <motion.div
          ...
          className="max-w-4xl"
        >
          <h1 className="text-white text-2xl md:text-6xl font-bold  leading-tight  uppercase">
            TRUBAČI <span className="gold-accent">VELIKA PLANA</span> Smederevo,
            Požarevac, Batočina, Žabari
          </h1>
        </motion.div>
        ...
        <motion.div
          ...
          className="bg-black/30 backdrop-blur-sm rounded-lg p-3 md:p-8 max-w-3xl border border-yellow-400/30"
        >
          <p className="text-base md:text-2xl font-light leading-relaxed">
            Profesionalni trubački orkestar za{" "}
            <strong>svadbe, slave i proslave</strong> u Velikoj Plani,
            Smederevu, Požarevcu i celoj Srbiji
          </p>
        </motion.div>
